        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-card text-card-foreground border border-border rounded-lg w-[90vw] max-w-xl p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3">
                <Button variant="outline" onClick={pickFile} className="px-4 py-2">Change Image</Button>
                {newImagePath !== null && <Button variant="outline" onClick={revertImage} className="px-4 py-2">Revert</Button>}
              </div>
              ...
              }} isLoading={saving} className="px-4 py-2">Save</Button>
              </div>
          </div>
        </div>
      )}
